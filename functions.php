 ...
 */
function phel_wp_theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'phel_wp_theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'phel_wp_theme_content_width', 0 );
